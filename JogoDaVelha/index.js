...
function play(y){
    if(y.dataset.player=="none" && window.isGameOver==false){
        ...
        if (playerTurn == "x") {
            y.innerHTML = '<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmgzcDRza3BiZWZsMTZqaDhwYjVlMmUzY3BmeXRxcTM3NmcyaWNnOCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/qDOI1FqYEyTxkW0MEI/giphy.gif">';
        } else {
            y.innerHTML = '<img src="https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3ZGF1eDMyNjRlcG5mcDZrNDJvM2RpNWNjaDZrb3Y1MmNrYnBta3NkNCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/MXUXgMiF3Cn5iWRYpZ/giphy.gif">';
        }
